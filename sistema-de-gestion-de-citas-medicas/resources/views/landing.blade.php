...
<body>
    ...
    <!-- ============================================================
         NAVBAR FIJA — CTA "Iniciar Sesión" siempre visible
    ============================================================ -->
    <nav class="navbar navbar-expand-lg navbar-light landing-nav fixed-top">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center gap-2 fw-bold text-white" href="{{ route('landing') }}">
                <img src="{{ asset('assets/logo-am.svg') }}" alt="Logo Agenda Médica" width="34" height="34" class="landing-logo">
                Agenda <span class="text-landing-light">Médica</span>
            </a>

            <button class="navbar-toggler border-0 text-white" type="button" data-bs-toggle="collapse" data-bs-target="#navLanding" aria-controls="navLanding" aria-expanded="false" aria-label="Abrir menú">
                <i data-lucide="menu" class="text-white"></i>
            </button>

            <div class="collapse navbar-collapse" id="navLanding">
                <ul class="navbar-nav mx-auto gap-lg-3">
                    <li class="nav-item"><a class="nav-link text-white-50" href="#inicio">Inicio</a></li>
                    <li class="nav-item"><a class="nav-link text-white-50" href="#perfiles">Elige tu Perfil</a></li>
                    <li class="nav-item"><a class="nav-link text-white-50" href="#beneficios">Beneficios</a></li>
                    <li class="nav-item"><a class="nav-link text-white-50" href="#cta-final">Empieza Hoy</a></li>
                </ul>
    ...
    <!-- ============================================================
         HERO — Título + Subtítulo + 2 CTAs principales
    ============================================================ -->
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    <span class="landing-badge d-inline-flex align-items-center gap-2 mb-3">
                        <i data-lucide="activity" style="width: 16px; height: 16px;"></i> Salud digital para tu clínica
                    </span>
                    <h1 class="landing-hero-title mb-3">
                        Tu salud, <span class="text-landing-primary">a un toque</span> de distancia
                    </h1>
                    <p class="landing-hero-subtitle mb-4">
                        Agenda, consulta y controla tus citas médicas desde cualquier dispositivo.
                        Sistema digital para pacientes y personal clínico que elimina filas,
                        reduce tiempos de espera y moderniza la gestión de tu centro de salud.
                    </p>
                    ...
                    <p class="landing-hero-note d-flex align-items-center gap-2 mb-0">
                        ...
                        Acceso seguro · Sin llamadas · Sin filas · Disponible 24/7
                    </p>
                </div>

                <div class="col-lg-6">
                    <div class="landing-hero-visual p-4 p-lg-5 text-center">
                        <img src="{{ asset('assets/logo-am.svg') }}" alt="Agenda Médica" class="mb-4" style="width: 96px; height: 96px; filter: drop-shadow(0 8px 24px rgba(27,107,147,0.35));">
                        <h3 class="fw-bold text-landing-primary mb-2">Agenda Médica</h3>
                        <p class="text-landing-secondary mb-4">Sistema de Gestión de Citas Médicas</p>
                        <div class="row g-3 text-start">
                            <div class="col-6">
                                <div class="landing-mini-stat">
                                    <i data-lucide="calendar-check" class="text-landing-secondary"></i>
                            ...
                            <div class="col-6">
                                <div class="landing-mini-stat">
                                    <i data-lucide="timer" class="text-landing-accent"></i>
                            ...
                            <div class="col-6">
                                <div class="landing-mini-stat">
                                    <i data-lucide="file-text" class="text-landing-primary"></i>
                                    <strong>Expedientes</strong>
                                    <span>Centralizados</span>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="landing-mini-stat">
                                    <i data-lucide="link-2" class="text-landing-danger"></i>
                                    <strong>Cero duplicados</strong>
                                    <span>Información consistente</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section id="perfiles" class="landing-section">
        <div class="container">
            <div class="text-center mb-5">
                <h2 class="landing-section-title">Elige tu Perfil</h2>
                <p class="landing-section-subtitle mx-auto">
                    Una plataforma, dos experiencias. Inicia sesión y descubre todo lo que
                    encontrarás dentro de tu espacio.
                </p>
            </div>
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-lg-6">
                    <div class="landing-card landing-card-patient h-100">
                        ...
                        <span class="landing-chip landing-chip-blue mb-3">Portal del Paciente</span>
                        <h3 class="landing-card-title">Para Pacientes</h3>
                        <p class="landing-card-text">
                            Gestiona tu salud desde la palma de tu mano, sin intermediarios y
                        ...
                        <ul class="landing-card-list">
                            ...
                            <li><i data-lucide="calendar-plus" class="text-landing-secondary"></i> Agendamiento de citas disponible 24/7</li>
                            <li><i data-lucide="history" class="text-landing-secondary"></i> Historial médico y diagnósticos al alcance</li>
                            <li><i data-lucide="bell-ring" class="text-landing-secondary"></i> Cancelación y reprogramación sin filas</li>
                        </ul>
                        <div class="mt-auto">
                ...
                <div class="col-lg-6">
                    <div class="landing-card landing-card-staff h-100">
                        ...
                        <p class="landing-card-text">
                            Panel web diseñado para médicos, recepcionistas y administradores.
                            Control total y en tiempo real del flujo diario de consultas.
                        </p>
                        <ul class="landing-card-list">
                            <li><i data-lucide="calendar-days" class="text-landing-primary"></i> Administración de agendas y horarios de doctores</li>
                            <li><i data-lucide="folder-open" class="text-landing-primary"></i> Expedientes y diagnósticos centralizados</li>
                            <li><i data-lucide="workflow" class="text-landing-primary"></i> Control del flujo de citas: check-in y estados</li>
                            <li><i data-lucide="bar-chart-3" class="text-landing-primary"></i> Reportes e indicadores del centro de salud</li>
                        </ul>
                        <div class="mt-auto">
    ...
    <section id="beneficios" class="landing-section landing-section-tinted">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="landing-section-subtitle mx-auto">
                    Menos espera, cero errores y una clínica modernizada de punta a punta.
                </p>
            </div>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-3">
                    <div class="landing-benefit">
                        ...
                        <h4>Adiós a las llamadas</h4>
                        <p>Agenda, cancela o reprograma tus citas de forma autónoma, sin largas llamadas telefónicas ni intermediarios.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="landing-benefit">
                        ...
                        <h4>Cero filas</h4>
                        <p>Acudir al centro solo para pedir una cita es historia. El agendamiento digital está disponible 24/7.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="landing-benefit">
                        ...
                        <p>El personal clínico monitorea el flujo diario de consultas y expedientes con una vista centralizada.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="landing-benefit">
                        ...
                        <p>Elimina citas duplicadas, historiales dispersos e inconsistencias con una sola fuente de verdad.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- ============================================================
         CTA FINAL — Urgente pero amigable
    ============================================================ -->
    <section id="cta-final" class="landing-section">
        <div class="container">
            <div class="landing-cta-final rounded-4 text-center">
                ...
                <h2 class="landing-section-title text-white mb-2">Tu próxima cita está a un clic</h2>
                <p class="landing-cta-text mx-auto mb-4">
                    Entra ahora mismo al panel web y gestiona tu salud desde cualquier
                    dispositivo. Crear tu cuenta toma menos de 2 minutos y no necesitas
                    nada más que tu correo.
                </p>
    ...
    <footer class="landing-footer py-4">
        <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between gap-2 text-center">
            <div class="d-flex align-items-center gap-2 fw-bold text-white">
                <img src="{{ asset('assets/logo-am.svg') }}" alt="Logo Agenda Médica" width="24" height="24">
                Agenda Médica
            </div>
