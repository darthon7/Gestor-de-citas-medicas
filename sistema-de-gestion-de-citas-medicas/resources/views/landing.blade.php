...
<body class="bg-brand-bg text-brand-heading font-sans antialiased overflow-x-hidden selection:bg-brand-emerald selection:text-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-7 space-y-6 text-left">
                    ...
                    <!-- Rating / Stars Badge -->
                    <div class="inline-flex items-center gap-3 px-3.5 py-1.5 rounded-full bg-white border border-brand-border shadow-sm">
                        ...
                        <span class="text-xs sm:text-sm font-medium text-brand-muted">
                            <strong class="text-brand-heading font-bold">4.8</strong> en Google Play · +500 mil descargas
                        </span>
                    </div>
    ...
    <section id="contacto" class="py-16 lg:py-20 bg-brand-dark text-white text-center relative overflow-hidden">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 relative z-10">
            ...
            <p class="text-xs text-zinc-400 pt-2">Sin anuncios · Datos protegidos · Cancela cuando quieras</p>
